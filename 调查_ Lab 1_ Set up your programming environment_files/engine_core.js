...
eesy.define('engine_core', ['jquery-private', 'context-probe', 'context-handling', 'json!context-node-link-data',
        ...
        function handleLtiReadyEvent(e) {
            if (e.source !== null) {
                ...
                e.source.postMessage({
                    eesysoftloader: "//" + dashboardUrl + "/loader.jsp" +
                        "?stmp=" + new Date().getTime() +
                        "&listento=top.nav" +
                        "&embedded=true" +
                        "&showquicklink=false" +
                        "&k=" + sessionInfo.sessionKey() +
                        "&isLtiLaunch=true"
                }, "*");
    ...
    function handleFocusChange(e) {
        ...
        var isKeyboardNavigation = target.matches(':focus-visible');
    ...
    function timedLookup() {
        var _a;
        var isKeyboardNavigation = Boolean((_a = document.activeElement) === null || _a === void 0 ? void 0 : _a.matches(':focus-visible'));

"use strict";
eesy.define('context-handling', ['jquery-private', 'context-probe', 'monitor-handling', 'helpitem-handling', 'engine-state'], function ($, ctxProbe, monitorhandling, helpitemhandling, engineState) {
    return {

"use strict";
eesy.define('popups', ['jquery-private', 'json!settings-supportcenter', 'mustachejs', 'presentation-helper', 'focus-trap'], function ($, settings, Mustache, presentationHelper, focusTrap) {

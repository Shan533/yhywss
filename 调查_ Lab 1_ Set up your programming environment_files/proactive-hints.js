...
eesy.define('proactive-hints', [
    'jquery-private', 'utils', 'mustachejs', 'presentation-helper', 'helpitem-visibility', 'eesy-timers', 'helpitem-accessibility'
    ...
    function calcMetrics(connectTo, hintWidth, hintHeight, surveyOffset) {
        ...
        var space = {
            below: (target.top + target.height + hintMetrics.height + surveyOffset + hintOffset) < scrollTop + windowHeight,
        ...
        var canCenter = {
            ...
            y: (hintMetricsCentered.top >= 0)
                && (hintMetricsCentered.top + hintMetrics.height + surveyOffset + hintOffset) < windowHeight + scrollTop
